      ...
      <div className="container mt-5 mb-3">
        ...
        >
          ...
          <div className="tab-content container-sm text-black">
            ...
            >
              <p>
                “Digital transformation as more than just technology, it’s about
                rethinking business models, operations, and relationships with
                customers and ecosystems.” The transformational world of
                business environment in the digital space has redefined
                parameters of success and competitiveness. In this context, IMT
                Hyderabad proposes to set up a Centre for Digital Transformation
                to provide research and other collaborative insights for Digital
                Transformation initiatives and provide significant value to a
                range of stakeholders including corporates, government
                organisations, non-government organisations, advisory & think
                tank organisations and students. Using various conceptual
                frameworks that integrate theories and developments in
                information systems, economics and other business disciplines,
                the centre examines digital transformation, emphasizing on the
                      ...
                      <div className="col-md-7">
                        <div className="card-body">
                          ...
                          <p>
                            ...
                            (I&C) and Information Technology (IT) Departments of
                    ...
                    <div className="row g-0">
                      ...
                      <div className="col-md-7">
                        <div className="card-body">
                          ...
                          <p>Dean & Professor, IMT Hyderabad</p>
                          <Link
                            href="/faculties"
                            className="btn bg-warning text-white px-3 py-2 rounded-4"
                          >
                ...
                <div className="col-12 col-md-6 mb-4">
                  <div className="card h-100 p-4">
                    <div className="row g-0">
                      ...
                      <div className="col-md-7">
                        <div className="card-body">
                          <p className="fw-bold fs-5">Dr. Mahesh Ramalingam</p>
                          <p>
                            Assistant Professor
                            <br />
                ...
                <div className="col-12 col-md-6 mb-4">
                  <div className="card h-100 p-4">
                    <div className="row g-0">
                      ...
                      <div className="col-md-7">
                        <div className="card-body">
                          <p className="fw-bold fs-5">Dr. Kalyan C Chejarla</p>
                          <p>
                            Assistant Professor
                            <br />
