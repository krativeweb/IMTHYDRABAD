    ...
    conferences: [
      {
        ...
        support: 'Tie Ups',
        journal: 'International Journal of Economics and Business Research (An Inderscience Journal, Scopus Indexed, and ABDC-C category)',
        brochure: 'Flyer',
      },
      {
        title: 'MCEM-2019',
        ...
        theme: 'Digital Practices and Trends in Emerging Economies: Social & Business Perspective',
        support: 'Supported by Association of Management Development Institute of South Asia (AMDISA)',
        journal: 'International Journal of Environment, Workplace and Employment (An Inderscience Journal, Scopus Indexed, and ABDC-C category)',
        brochure: 'Flyer',
      },
      {
        title: 'MCEM-2017',
      ...
      },
      {
        ...
        theme: 'Marketing Challenges in Emerging Markets',
        support: 'In Collaboration with EM Normandie France and Corvinus University of Budapest',
        journal: 'NA',
        brochure: 'Flyer',
      },
    ],
