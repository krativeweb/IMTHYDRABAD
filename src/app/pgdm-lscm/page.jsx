...
The ISCM specialization develops expertise in operations, logistics, and supply chain excellence with global perspective.
        </p>
      </div>
            ...
            <div className="card-body">
              <div className="tab-content" id="pgdmTabContent">
                ...
                <div className="tab-pane fade" id="pedagogy" role="tabpanel" aria-labelledby="pedagogy-tab">
                  <p>
                    The courses are delivered using a mix of pedagogical methods such as case discussions, lectures, simulation, industry visits, seminars, guest lectures, and leverages experiential learning through industry projects.
                  </p>
                </div>
