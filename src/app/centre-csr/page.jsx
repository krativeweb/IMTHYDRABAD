          ...
          >
            ...
            <div className="tab-content container-sm text-black mb-4">
              ...
              >
                ...
                <br />
                <br />
                <div className="center_award">
                  <div className="camp_imgg">
                    <img
                      src="/media/center-csr/csr.png"
                      alt="Preeti Sharma Assistant Professor awarded"
                      width="100%"
                ...
                <div className="crs_list">
                  <ul>
                    <li>
                      ...
                      sustainability initiatives of the collaborating partners
                ...
                <div className="crs_list">
                  <ul>
                    <li>
                      Entering into agreements/ MoUs with organisations engaged
                      in Sustainability and CSR for promoting collaboration.
                    </li>
                    <li>
                      Encouraging people-centric research, studies and
                      innovative initiatives by practitioners and scholars for
                      the benefit of all stakeholders, especially industry and
                      academics.
                    </li>
                    <li>
                      ...
                      <div className="row g-0">
                        ...
                        <div className="col-md-7">
                          <div className="card-body">
                            ...
                            <button className="bg-warning text-white px-3 py-2 border-0 rounded-4">
                              View Profile
                            </button>
                          </div>
                        </div>
                  ...
                  <div className="col-12 col-md-6 mb-3 mb-md-0">
                    <div className="card h-100 p-4">
                      <div className="row g-0">
                        ...
                        <div className="col-md-7">
                          <div className="card-body">
                            <p className="card-title">Shri Ashok K. Pavadia</p>
                            <br />
                            <p className="card-text">Founder & Director</p>
                            <p className="card-text">
                              Council for Research on Policy and Governance
              ...
              <div className="tab-pane fade" id="sub-res-susne" role="tabpanel">
                <p>
                  ...
                  vision of the center contributing to nurturing socially
