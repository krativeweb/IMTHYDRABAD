...
Our Centre for Sustainability and CSR integrates responsible management and social innovation into education and research.
          </p>
        </div>
        ...
        >
          ...
          <div className="tab-content container-sm text-black mb-4">
            ...
            >
              ...
              <p>
                The Centre for Sustainability and CSR at IMT Hyderabad provides
                a collaborative eco-system for researchers, practitioners,
                students, inter-governmental organizations, governments
                organizations, non-government organizations, social incubators,
              ...
              <ul>
                <li>
                  The Centre for Sustainability and CSR aims to provide thought
                  leadership through action research projects and round table
                  discussions in order to promote CSR and sustainability
                  initiatives of the collaborating partners and community as a
                  whole.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  sustainability and CSR for wider advocacy of the concepts and
                  upgrading the knowledge and competence for successful
                  strategic implementation practices.
                </li>
                <li>
                  Funding long-term research studies undertaken by IMT H
                  faculty. Providing advisory support and capacity building help
                  to NGOs and other organisations engaged in providing
                  sustainable development solutions.
                </li>
                <li>
                  Extending help to corporates and other organizations in
                  formulation of their sustainability and CSR policies and their
                  strategic implementation.
                </li>
                <li>
                  Organizing knowledge exchange programs/visits with reputed
                  International bodies, agencies and institutes to keep abreast
                  with the global best policies and practices in the domain of
            ...
            {/* === People Tab === */}
            <div className="tab-pane fade" id="sub-res-suspep" role="tabpanel">
              {/* === Advisory Council === */}
            ...
            <div className="tab-pane fade" id="sub-res-susne" role="tabpanel">
              <p>
                IMT Hyderabad held an inauguration ceremony to launch the Centre
                for Sustainability and CSR on 7th August 2021. The session began
                with an inaugural address by Prof. (Dr.) Tulika Sharma,
                Chairperson - Centre for Sustainability & CSR. The event
                presided under Shri Ashok K Pavadia, Founder & Director, Council
                for Research on Policy & Governance and Lead Expert & Mentor,
                Centre for Sustainability and CSR, Shri Shoury Reddy, Advisor,
                Centre for Sustainability & CSR and Executive Director, BVIC,
                Shri Atul Sobti, Director General, SCOPE, and Shri Dr. S.K.
                Joshi, Advisor, Centre for Sustainability & CSR and Former Chief
                Secretary, Govt. of Telangana. They discussed their views on
                sustainability and how CSR aims to achieve and maintain social
                well-being, environmental and ecological preservation.
              </p>
              <p>
                ...
                Rambalak Yadav proposing a vote of thanks to all the dignitaries
                for their valuable time and suggestions in the domain of
                sustainability.
              </p>
            </div>
          </div>
