    ...
    border-radius: 30px 0 0 30px;
      ...
      {/* Top Banner */}
       <div
        ...
        style={{
          background:
            "url(/media/banners/placementbanner.jpeg)",
          position: "relative",
...
Our placement ecosystem connects talent with leading organizations, ensuring strong outcomes and professional growth for every student.
        </p>
      </div>
        ...
        <div className="container">
          <div className="row text-center justify-content-center">
            {[
              ...
              { number: "#35", text: "Private B-Schools by Careers360", delay: 300 },
      ...
      <section className="directors-message py-5">
        <div className="container">
          <div className="message-wrapper bg-white shadow-sm rounded-4 p-4 p-md-5 position-relative">
            <h2 className="fw-bold text-dark mb-4 text-center text-md-start">Director’s Message</h2>
            <img
            ...
            <div className="text-secondary lh-lg">
              <p>
                It is my privilege to invite your esteemed organization to participate in IMT Hyderabad’s campus
                recruitment process for the 2024–25 academic year. We take great pride in presenting our thirteenth
                postgraduate batch — a cohort of exceptional young professionals poised to make significant contributions
                in today’s dynamic business landscape shaped by Industry 5.0.
              </p>
              <p>
                At IMT Hyderabad, we have cultivated a distinctive “Know-Do-Be” educational philosophy that transcends
                conventional learning. Our approach integrates rigorous academic training with real-world exposure,
                developing leaders who combine technical expertise with emotional intelligence and social awareness.
              </p>
              <p>
                The curriculum blends Harvard and Ivey case methodologies with international immersion experiences, while
                our community initiatives foster responsible leadership. This holistic development model produces
                graduates with sharp analytical capabilities, strong interpersonal skills, and the agility to navigate
                complex business challenges.
              </p>
              <p>
                Over the past twelve years, our alumni network has established an impressive track record of driving
                innovation and delivering sustainable results across diverse sectors. The current batch embodies this
                legacy while bringing fresh perspectives shaped by emerging industry paradigms.
              </p>
              <p>
                We are confident that their unique blend of theoretical knowledge, practical orientation, and creative
                problem-solving abilities will add substantial value to your organization.
              </p>
              <p>
                Our dedicated placement team stands ready to customize the recruitment process to your specific
                requirements. We look forward to welcoming you to our campus and facilitating meaningful connections with
                these promising future leaders.
              </p>
              <div className="mt-4">
                <p className="fw-bold text-dark mb-0">Warm Regards,</p>
                <p className="fw-bold text-dark mb-0">Prof. (Dr.) K. M. Baharul Islam</p>
        ...
        <div className="container">
          <div className="card border-0 shadow-lg rounded-4 p-4 p-md-5">
            <div className="position-relative">
              ...
              />
              <h2 className="h4 fw-bold text-dark mb-1">Message from the Head, Corporate Relations</h2>
              <hr className="border-dark opacity-50 w-25 mb-3" />
              <div className="text-dark fs-6 lh-lg mt-3">
                <p>Dear Recruiters,</p>
                <p>
                  I am pleased to invite you for campus placements of our PGDM Class of 2026 students. IMT Hyderabad is a
                  part of the IMT Group and the institute is well known for its quality education and is a preferred
                  destination for students who are seeking management education. With our management education experience
                  of more than four decades, we have been able to provide an edge over our contemporaries, that goes a
                  long way in grooming our students to not only be industry-ready, but also future-ready.
                </p>
                <p>
                  The last year has been affected by many global and domestic events that had an impact on campus
                  placements across all institutes and universities. However, IMT Hyderabad has been able to respond by
                  taking extra measures for our placements. Even this year, recruiters like{" "}
                  <strong>Arcesium, BNY, Micron, HCL, Berkedia, Oracle, PepsiCo, Volvo, Zeta Global, Sony India, Wipro,
                  Infosys, Cognizant, Advance Auto Parts, Voltas, Nerolac, CRISIL, Netelixir</strong> and many more
                  conducted campus placement process and selected our students, with a <strong>highest CTC of ₹31
                  LPA</strong> and an <strong>average CTC of ₹12.2 LPA</strong>.
                </p>
                <p>
                  The batch of 2024–26 is a good mix of students from all backgrounds, and has students from Engineering
                  (18%), Arts & Commerce (47%), Management (18%) and Science (16%). There are students with work
                  experience greater than 2 years (5%), less than 2 years (14%), and freshers (81%). Besides diverse
                  backgrounds, the batch is a good mix of gender diversity with <strong>34% female students</strong>.
                </p>
                <p>
                  The students specialize in the areas of Marketing, Finance, HR, Operations, IT, Analytics, and General
                  Management. All the students have undergone a 12-week summer internship which gives them a good notion
                  of the market trends. The students contribute substantially and at the same time gain valuable learning
                  during their summer internships.
                </p>
                <p>
                  I extend a warm invite to you to attend our final placement process for the Class of 2026 and look
                  forward to a symbiotic relationship.
                </p>
      ...
      <section className="py-3">
        <div className="container">
          <h3 className="section-title text-center mb-4">Sector Wise Statistics</h3>
          <div className="card placement-card">
            <div className="img-container">
              <img src="/media/stats.webp" className="img-fluid rounded" alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-3">
        <div className="container-fluid">
          <h3 className="section-title text-center mb-4">Batch Profile PGDM CLASS 2026</h3>
          <div className="row">
            {["/media/stat2.webp", "/media/stat3.webp", "/media/stat4.webp", "/media/stat5.webp"].map((src, index) => (
        ...
        <div className="sticky-buttons">
          <a href="https://drive.google.com/file/d/1fHoddrt_trxb8hyxATXnJzMkvM3iEPaH/view" target="_blank" className="sticky-btn">
            Recruiters Handbook
          </a>
          <a href="https://drive.google.com/file/d/1jkjfW8OBofArrSCjurKNVK5Vr2YS_KvB/view" target="_blank" className="sticky-btn">
            Placement Brochure
          </a>
          <a href="https://drive.google.com/file/d/19gMWjbmz6xe69NqulcQVu0trDjssKJw5/view" target="_blank" className="sticky-btn">
            Summer Internship
          </a>
        </div>
      </section>
