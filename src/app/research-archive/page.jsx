                      ...
                      <div className="col-md-8">
                        <div className="card-body">
                          ...
                          <p className="card-text  fs6">
                            <strong>Title:</strong> Predicting BRICS NIFTY50
                            returns using XAI and S.A.F.E AI lens
                          </p>
                          <p className="card-text  fs6">
                            <strong>Authors:</strong> Indranil Ghosh, Tamal
                            Datta Chaudhuri, Golnoosh Babaei, Paolo Giudici,
                            Emanuela Raffinetti
                          </p>
                          <p className="card-text  fs6">
                          ...
                          <p className="card-text  fs6">
                            <strong>Volume:</strong> Capital structuring
                            decisions, CSR, ESG
                          </p>
                          <p className="card-text  fs6">
                            <strong>URL:</strong>
                            <Link href="">
                              {" "}
                              Frontiers | Predicting BRICS NIFTY50 returns using
                              XAI and S.A.F.E AI lens
                            </Link>{" "}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body text-start">
                            Global fund managers, in their effort toward risk
                            diversification and generating higher returns,
                            design portfolios that consist of financial assets
                            of various countries. In the process, they expose
                            their investors not only to the fundamentals of the
                            assets but also to transnational volatility,
                            macroeconomic shocks of different countries, and
                            exchange rate fluctuations. These factors make
                            forecasting returns from such global funds quite
                            difficult and, at the same time, challenging. To aid
                            global fund managers and investors, this study
                            presents a forecasting framework for predicting
                            returns from Goldman Sachs BRICs Nifty 50 Developed
                            Markets Index (BRICS NIFTY 50), which is a traded
                            and listed financial asset. It is a global
                            portfolio, which not only exposes investors to the
                            fundamentals of different companies but also to
                            country risk.
                          </div>
                        </div>
                      </div>
